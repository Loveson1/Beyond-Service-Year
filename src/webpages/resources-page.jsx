...
export default function ResourcePage() {
  ...
  return (
    <div className="bg-black">
      <div className=" bg-opacity-30 bg-blend-darken bg-black bg-resource bg-cover max-sm:bg-center bg-no-repeat w-screen min-h-[100vh]  ">
        {/* Navbar section */}
        ...
        {/* Resource section */}
        <div className="container flex  max-sm:flex flex-col justify-center  items-center">
          <div>
            ...
            <p className="mt-sm opacity-90 mx-auto text-center lg:w-[600px]">
              ...
              supportive community to help you{" "}
